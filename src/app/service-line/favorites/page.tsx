        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-1.5 bg-slate-100/80 p-1.5 rounded-full shadow-inner">
            <button
              ...
              className={`px-4 py-2 text-xs font-semibold rounded-full transition-all duration-200 cursor-pointer ${activeTab === 'messages'
            ...
            <button
              ...
              className={`px-4 py-2 text-xs font-semibold rounded-full transition-all duration-200 cursor-pointer ${activeTab === 'contacts'
                  ? 'bg-[#06530b] text-white shadow-sm'
                  : 'text-gray-500 hover:text-slate-800 hover:bg-slate-200/50'
                }`}
            >
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {activeTab === 'messages' && (
          <>
            ...
            <div className={`w-full lg:w-[469px] border-r border-[#dadada] flex flex-col h-full bg-white shrink-0 transition-transform duration-300 z-10 ${activeMessageId && !isMessageDetailsOpen ? 'hidden lg:flex' : activeMessageId && isMessageDetailsOpen ? 'hidden lg:flex' : 'flex'
              }`}>
            ...
            <div className={`flex-1 h-full bg-slate-50 transition-transform duration-300 ${activeMessageId ? 'flex' : 'hidden lg:flex'
              }`}>
              <ChatArea
                activeChat={
        ...
        {activeTab === 'contacts' && (
          <>
            ...
            <div className={`w-full lg:w-[469px] border-r border-[#dadada] flex flex-col h-full bg-white shrink-0 transition-transform duration-300 z-10 ${activeContactId && !isContactDetailsOpen ? 'hidden lg:flex' : activeContactId && isContactDetailsOpen ? 'hidden lg:flex' : 'flex'
              }`}>
            ...
            {/* Middle Pane: Chat Area Feed */}
            <div className={`flex-1 h-full bg-slate-50 transition-transform duration-300 ${activeContactId ? 'flex' : 'hidden lg:flex'
              }`}>
              <ChatArea
                activeChat={
                  selectedContact
