...
export default function UpdateProjectGroupPage() {
    ...
    <div className="h-full max-w-full overflow-hidden p-4 md:p-6">
      <div className="h-full overflow-y-auto no-scrollbar">
        <div className="pb-12 w-full  mx-auto">
          ...
          {/* Top Header with Badges from Node 350:6607 */}
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
              ...
              <div className="flex items-center gap-2 ml-auto md:ml-2">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#06530B] hover:bg-[#05290b] text-white rounded-xl text-xs md:text-sm font-bold transition-colors shadow-sm"
                >
                  {isSuccess ? (
                    <>
                      <CheckCircle2 className="w-4 h-4 text-green-300" /> Updated!
                    </>
                  ) : (
