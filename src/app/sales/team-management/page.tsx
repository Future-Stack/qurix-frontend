...
function SalesTeamManagementContent() {
    ...
    { key: 'lastLogin', header: 'Last Login', render: (val) => <span className="text-[13px] font-medium text-[#475569]">{String(val)}</span> },
    {
      ...
      render: (val) => (
        <div className="flex items-center gap-2">
          <Link href={`/sales/employees/${val}/edit?returnTo=/sales/team-management?tab=Employee`} className="w-8 h-8 rounded-full flex items-center justify-center text-[#475569] hover:bg-gray-100 transition-colors">
            <Edit2 className="w-4 h-4" />
          </Link>
          <Link href={`/sales/employees/${val}?returnTo=/sales/team-management?tab=Employee`} className="flex items-center gap-1.5 text-[#06530B] hover:text-green-800 font-bold text-xs transition-colors">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <Link
                        href={`/sales/team-management/${team.id}`}
              ...
              <DashboardTable
                ...
                columns={[
                  ...
                  { key: 'updated', header: 'Last Updated', render: (val) => <span className="text-[13px] font-medium text-[#475569]">{String(val)}</span> },
                  {
                    ...
                    render: (_, team) => (
                      <div className="flex items-center gap-2">
                        <Link href={`/sales/team-management/${team.id}`} className="w-8 h-8 rounded-full flex items-center justify-center text-[#06530B] hover:bg-green-50 transition-colors">
              ...
              {filteredEmployees.map((member) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2.5">
                      <Link
                        href={`/sales/employees/${member.id}/edit?returnTo=/sales/team-management?tab=Employee`}
                        className="flex-1 h-[29px] bg-[rgba(125,125,125,0.13)] hover:bg-gray-300 text-[#333333] rounded-[8px] flex items-center justify-center gap-1 text-[14px] font-medium transition-colors cursor-pointer"
                      >
                        <Edit2 className="w-4 h-4" /> Edit
                      </Link>
                      <Link
                        href={`/sales/employees/${member.id}?returnTo=/sales/team-management?tab=Employee`}
                        className="flex-1 h-[29px] bg-[#06530B] hover:bg-[#05290b] text-white rounded-[8px] flex items-center justify-center gap-1 text-[14px] font-semibold transition-colors cursor-pointer"
                      >
                        <Eye className="w-4 h-4" /> View
                      </Link>
