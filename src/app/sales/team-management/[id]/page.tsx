...
export default function SalesTeamDetailsPage() {
  ...
  const projectColumns: Column<(typeof mockProjects)[0]>[] = [
    ...
    { key: 'seconds', header: 'Timeline', render: (_, item) => <CountdownTimer initialSeconds={item.seconds} /> },
    {
      ...
      header: 'Actions',
      render: (val) => (
        <Link href={`/sales/dashboard`} className="flex items-center gap-1.5 text-[#06530B] font-bold text-xs hover:text-green-800 transition-colors">
  ...
  const memberColumns: Column<(typeof mockMembers)[0]>[] = [
    ...
    { key: 'lastLogin', header: 'Last login', render: (val) => <span className="text-[13px] font-medium text-[#475569]">{String(val)}</span> },
    {
      ...
      header: 'Action',
      render: (val) => (
        <Link href={`/sales/employees/${val}`} className="flex items-center gap-1.5 text-[#06530B] hover:text-green-800 font-bold text-xs transition-colors">
          <Eye className="w-4 h-4" /> View
        </Link>
      )
    }
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 border-b border-[#E2E8F0] pb-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Link
              href={`/sales/team-management/${teamId}/create-project`}
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <Link
                        href={`/sales/employees/${member.id}`}
